#     The following code is a modified version of the efficientnet_v2 code 
#     from the official tensorflow implementation to support different
#     output strides to be used as a backbone for DeepLabV3+. 
#     
#     Title: Tensorflow
#     Author: TensorFlow Authors
#     Date: Jul 18, 2022
#     Code version: 2.10
#     Availability: https://github.com/keras-team/keras/blob/v2.10.0/keras/applications/efficientnet_v2.py
...
def EfficientNetV2(
    ...
    "efficientnetv2-s": [
        ...
        },
        {
            ...
            "output_filters": 128,
            "se_ratio": 0.25,
            "strides": STRIDES["stage_4"][output_stride],
            "dilation_rate": DILATION_RATES["stage_4"][output_stride]
        },
        {
            "conv_type": 0,
            "expand_ratio": 6,
        ...
        },
        {
            ...
            "output_filters": 256,
            "se_ratio": 0.25,
            "strides": STRIDES["stage_6"][output_stride],
            "dilation_rate": DILATION_RATES["stage_6"][output_stride]
        },
    ],
    "efficientnetv2-m": [
        {
